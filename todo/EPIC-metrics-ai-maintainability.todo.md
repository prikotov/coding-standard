...
- scc — обязательный внешний Go-бинарник для проверки полноты структурных метрик; покрытие требует расширения PCOV и остаётся опциональным (TASK-metrics-codebase-size).
