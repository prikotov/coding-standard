...
final class MetricsDashboardGeneratorTest extends TestCase
{
    public function testGeneratesOfflineDashboardFromMirrorReports(): void
    {
        ...
        try {
            ...
            self::assertStringContainsString('class="chart-frame treemap-frame"', $html);
            self::assertStringContainsString('const minimumModuleWidth = id =>', $html);
            self::assertStringContainsString('moduleHeaderLines(module.id).forEach', $html);
