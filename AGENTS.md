...
- Главный артефакт для ИИ-агента — машиночитаемая структура из корневого,
  каталоговых и файловых JSON-отчётов. HTML-дашборд является дополнительным
  представлением снимка для человека.
