...
3. **Метрики качества** — дополняют автоматические проверки конвенций оценкой структуры и связанности подключаемого проекта; результат формируется в виде автономного HTML-дашборда.
