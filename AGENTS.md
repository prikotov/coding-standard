...
Этот репозиторий разрабатывает инструменты метрик. Они анализируют не сам
`coding-standard`, а PHP-проект, который подключил пакет через Composer.
...
- Не используйте отчёт самого `coding-standard` как результат пользовательского
  сценария.
