...
Проверяются документы на русском языке (`ru`). Документ на другом языке помечается признаком языка и пропускается — так английские справочники и переводы не дают ложных срабатываний.
