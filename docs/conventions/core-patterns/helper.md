...
**Helper** — класс только со статическими методами для детерминированных утилитных операций внутри одного модуля (без I/O и скрытых входов).
...
Helper размещается в слое, где используется его логика. Примеры:
...
- Helper не должен заменять сервисы — если нужна инъекция зависимостей, создавайте сервис.
