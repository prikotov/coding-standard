...
```php
AppName\Common\Module\{ModuleName}\Domain\Service\{Context?}\{ServiceName}ServiceInterface
AppName\Common\Module\{ModuleName}\Domain\Service\{Context?}\{ServiceName}Service
```
...
```php
AppName\Common\Module\{ModuleName}\Infrastructure\Service\{Context?}\{ServiceName}Service
```
...
```php
AppName\Common\Module\{ModuleName}\Application\Service\{Context?}\{ServiceName}ServiceInterface
AppName\Common\Module\{ModuleName}\Application\Service\{Context?}\{ServiceName}Service
```
...
```php
AppName\Common\Module\{ModuleName}\Integration\Service\{Context?}\{ServiceName}Service
```
