...
```php
AppName\Common\Module\{ModuleName}\{Layer}\List\{GroupName?}\{Name}List
```

Где:
- `AppName` — корневой namespace проекта
...
Примеры:
- `AppName\Common\Module\Project\Domain\List\ProjectUserRolesList`
- `AppName\Common\Module\Project\Domain\List\ProjectUserSharedRolesList`
- `AppName\Common\Module\Billing\Infrastructure\List\CurrencyList`
...
```php
AppName\Common\Module\{ModuleName}\Application\UseCase\{Command|Query}\{QueryGroup?}\{CaseName}\{Name}List
```

Пример:
- `AppName\Common\Module\Project\Application\UseCase\Command\ShareProject\AvailableRolesList`
...
Примеры:
- `AppName\Web\Module\Project\List\FastFilterProjectStatusList`
- `AppName\Web\Module\User\List\FastFilterInvitationStatusList`
- `AppName\Web\Module\Source\List\FastFilterSourceStatusList`
...
namespace AppName\Web\Module\Project\List;
