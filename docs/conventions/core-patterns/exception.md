...
*Пример*: не указан получатель при отправке электронного письма.
...
*Пример*: пользователь с таким адресом электронной почты уже существует.
