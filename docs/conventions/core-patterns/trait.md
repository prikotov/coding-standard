...
- Трейт автономен: не требует методов/свойств хоста, не опирается на окружение, не тянет инфраструктуру. Если трейт становится "общим" — переносите его в `{AppName}\Common\Component\*`.
...
```
{AppName}\Common\Component\{ComponentName}\Trait\{Name}Trait
```

- Трейты для консольного приложения:

```
{AppName}\Console\Module\{ModuleName}\Trait\{Name}Trait
```

- Трейты модулей:

```
{AppName}\Common\Module\{ModuleName}\{Layer}\Trait\{Name}Trait
```
...
namespace {AppName}\Common\Component\Repository\Trait;

use {AppName}\Common\Component\Repository\Enum\SortEnum;
...
use {AppName}\Common\Component\Repository\CriteriaWithLimitInterface;
use {AppName}\Common\Component\Repository\CriteriaWithOffsetInterface;
use {AppName}\Common\Component\Repository\SortableCriteriaInterface;
use {AppName}\Common\Component\Repository\Trait\CriteriaWithLimitTrait;
use {AppName}\Common\Component\Repository\Trait\CriteriaWithOffsetTrait;
use {AppName}\Common\Component\Repository\Trait\SortableCriteriaTrait;
...
namespace {AppName}\Common\Component\Doctrine\Trait;
