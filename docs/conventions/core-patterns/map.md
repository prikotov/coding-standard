...
- Запрещено использовать `Map` напрямую для формирования UI-списков (выпадающих списков). Для этого используйте [Mapper-классы](mapper.md), которые используют `Map` и `List` вместе.
...
## Использование с Mapper для выпадающих списков

Для составления массивов для выпадающих списков используйте [Mapper-классы](mapper.md), которые комбинируют `Map` и `List`:
