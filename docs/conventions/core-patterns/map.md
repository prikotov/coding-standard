...
```php
AppName\Common\Module\{ModuleName}\{Layer}\Map\{Name}Map
```
...
Примеры:
- `AppName\Common\Module\User\Domain\Map\UserStatusTextMap`
- `AppName\Common\Module\Project\Application\Map\ProjectPriorityTextMap`
...
Примеры:
- `AppName\Web\Module\Project\Map\ProjectStatusTextMap`
- `AppName\Api\Module\Source\Map\SourceStatusTextMap`
...
namespace AppName\Web\Module\Project\Map;

use Symfony\Contracts\Translation\TranslatorInterface;
use AppName\Web\Module\Project\Enum\ProjectStatusEnum;
...
namespace AppName\Web\Module\Project\Mapper;

use AppName\Web\Module\Project\Enum\ProjectStatusEnum;
use AppName\Web\Module\Project\List\ProjectStatusList;
use AppName\Web\Module\Project\Map\ProjectStatusTextMap;
