...
- Именование: суффикс `Dto`. Контекст — в имени/namespace (Request DTO, Response DTO, Result DTO, `...Dto`).
...
- В Application `Use Case` принимает/возвращает DTO, маппит из/в доменные модели через Mapper.
