...
- Контейнер `database-test` использует `tmpfs` для каталога данных PostgreSQL, поэтому integration tests не создают лишний disk I/O на SSD и получают чистое состояние при пересоздании test stack.
...
| Файл | Описание |
|------|----------|
| [`UserFixtures.php`](../../examples/DataFixtures/UserFixtures.php) | Создаёт тестовых пользователей (test-user, test-user2, test-admin-user) |
| [`UserRoleFixture.php`](../../examples/DataFixtures/UserRoleFixture.php) | Создаёт роли для пользователей (user, admin) |
| [`ProjectFixtures.php`](../../examples/DataFixtures/ProjectFixtures.php) | Создаёт проекты с разными статусами (closed, new, active) |
| [`TeamFixtures.php`](../../examples/DataFixtures/TeamFixtures.php) | Создаёт команды |
| [`UserAccessTokenFixture.php`](../../examples/DataFixtures/UserAccessTokenFixture.php) | Создаёт токены доступа пользователей |
...
Подробная документация по E2E: [`docs/testing/e2e.md`](./e2e.md)
...
**Конфигурация:** [`phpunit.xml.dist`](../../examples/phpunit.xml.dist)
...
**Конфигурация:** [`psalm.xml`](../../examples/psalm.xml)
...
**Конфигурация:** [`depfile.yaml`](../../examples/depfile.yaml)
...
| [`Makefile`](../../examples/Makefile)               | Makefile с командами для запуска проверок  |
...
- [`docs/testing/e2e.md`](./e2e.md) — детальное руководство по E2E тестированию
- [`tests/AGENTS.md`](../AGENTS.md) — детальные правила тестирования (источник истины для тестов)
- [`AGENTS.md`](../AGENTS.md) — общие правила проекта, включая раздел Tests and Validation
- [`Makefile`](../../examples/Makefile) — команды для запуска тестов и проверок

> **Примечание:** Данный документ (`docs/conventions/testing/index.md`) является полным руководством по тестированию в проекте. Для получения наиболее актуальной информации о правилах тестирования используйте [`tests/AGENTS.md`](../AGENTS.md) как источник истины.
