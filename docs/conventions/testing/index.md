...
Подробная документация по E2E: [`docs/testing/e2e.md`](../../docs/testing/e2e.md)
...
**Конфигурация:** `phpunit.xml.dist` ([пример](../examples/phpunit.xml.dist))
...
**Конфигурация:** `psalm.xml` ([пример](../examples/psalm.xml))
...
**Конфигурация:** `phpcs.xml.dist` ([пример](../examples/phpcs.xml.dist))
...
6. **Соблюдайте общие правила из корневого `AGENTS.md` по стилю кода и покрытию тестами.**
...
| Файл                | Описание                                      |
|---------------------|-----------------------------------------------|
| `phpunit.xml.dist` | Конфигурация PHPUnit                         | [пример](../examples/phpunit.xml.dist) |
| `psalm.xml`             | Конфигурация Psalm                          | [пример](../examples/psalm.xml) |
| `phpcs.xml.dist`   | Конфигурация PHP_CodeSniffer                | [пример](../examples/phpcs.xml.dist) |
| `phpmd.xml`             | Конфигурация PHP Mess Detector              | [пример](../examples/phpmd.xml) |
| `Makefile`               | Makefile с командами для запуска проверок  | [пример](../examples/Makefile) |
...
- `Makefile` — команды для запуска тестов и проверок ([пример](../examples/Makefile))
