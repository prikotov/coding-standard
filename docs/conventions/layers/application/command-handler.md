...
# Команда и обработчик команды (Command и CommandHandler)
...
> использовании «Symfony Messenger» и очередей. Прямой вызов `CommandHandler` допустим для unit-тестов или простых MVP-прототипов.
