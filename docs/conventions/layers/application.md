...
**Application слой** — слой приложения, который оркеструет выполнение бизнес-операций, координирует взаимодействие между доменной логикой, инфраструктурой и внешними интерфейсами. Это уровень, где реализуются Use Case приложения.
...
- **Оркестрация бизнес-операций**: координирует выполнение Use Case, объединяя несколько операций домена в единый процесс
