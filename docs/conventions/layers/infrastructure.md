...
Описывает технические детали: реализации репозиториев, интеграция с БД/кэшем, Mapper критериев и прочие детали, скрывающие инфраструктуру от Domain/Application.
