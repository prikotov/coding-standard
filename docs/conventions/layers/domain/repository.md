...
- Для вычисляемых или сводных доменных значений ([Value Object](../../core-patterns/value-object.md): баланс на дату, сумма операций, статистика) создают отдельный репозиторий, а не добавляют такой метод в репозиторий сущности.
