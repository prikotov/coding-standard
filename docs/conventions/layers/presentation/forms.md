...
- Разрешено: сервисы Presentation (списки значений, Mapper), перечисления слоя, DTO Application в качестве данных.
...
Для часто используемых списков применяйте кэширование на уровне Query Handler или используйте List-сервисы (см. [List-сервисы](list-controller.md)).
